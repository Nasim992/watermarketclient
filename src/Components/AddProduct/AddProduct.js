...
const AddProduct = () => {
    ...
    const [isuploaad,setIsupload] = useState(false);
    ...
    const onSubmit = data => {
        ...
        const url = `https://serene-bastion-25210.herokuapp.com/addProduct`
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleImageUpload = event => {
        ...
        imageData.set('key', '449aaea15ebb5d3721a716b936ce4653');
    ...
    return (
        <div>
            ...
            {
                isuploaad===true && <p className="alert alert-success">Products Added Success</p>
            }
