...
const Header = () => {
    ...
    return (
            <nav className=" navbar navbar-expand-lg navbar-light bg-primary text-white sticky-top">
                <div className="container">
                <p className='pt-2 font-weight-bold'> <Link className='px-3 pt-2 link' to='/'>Water-Market</Link></p>
                ...
                <div className="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                    <div className="navbar-nav">
                        ...
                        {
                            email ? <p className="px-3 pt-2">{name || displayName}</p> : <button type="button" onClick={handleLogin} className="btn btn-secondary px-3 login-style">Login</button>
                        }
                        {
